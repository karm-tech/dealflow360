...
INSERT INTO "new_Settings" ("currency", "defaultShippingCost", "discountAnomalyThresholdPct", "financeApprovalOveragePoints", "healthWeights", "id", "minQuotesForRepAverage", "minUpsellMarginPct", "paymentTermsDays", "stalledAfterDays", "updatedAt") SELECT "currency", "defaultShippingCost", "discountAnomalyThresholdPct", "financeApprovalOveragePoints", "healthWeights", "id", "minQuotesForRepAverage", "minUpsellMarginPct", "paymentTermsDays", "stalledAfterDays", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
